// ** Type import
import { health_grocery_and_homeBusinessOnly, resturantOnly, storeOwnerOnly, superAdmin_AdminStaff_and_StoreOwner, superAdmin_and_storeOWner } from '@utils/auth-utils'
...
const storeOwnerNavigation = (shop: string): VerticalNavItemsType => {
  return ([
    ...
    {
      title: 'common:nav-store-owner-text-products',
      icon: 'heroicons-outline:user-group',
      path: `/${shop}${ROUTES.PRODUCTS}`,
      allowedRoles: superAdmin_AdminStaff_and_StoreOwner,
    },
    {
      title: 'common:nav-store-owner-text-orders',
      icon: 'fluent:building-shop-24-regular',
      path: `/${shop}${ROUTES.ORDERS}`,
      allowedRoles: superAdmin_AdminStaff_and_StoreOwner
    },
    {
      title: 'common:nav-store-owner-text-menu-categories',
      icon: 'fluent:building-shop-24-regular',
      path: `/${shop}${ROUTES.MENU_CATEGORYS}`,
      allowedRoles: storeOwnerOnly,
      allowedShops: resturantOnly
    },
    {
      title: 'common:nav-store-owner-text-categories',
      icon: 'fluent:building-shop-24-regular',
      path: `/${shop}${ROUTES.SHOP_CATEGORYS}`,
      allowedRoles: superAdmin_AdminStaff_and_StoreOwner,
      allowedShops: health_grocery_and_homeBusinessOnly
    },
    {
      title: 'common:nav-store-owner-text-sub-categories',
      icon: 'fluent:building-shop-24-regular',
      path: `/${shop}${ROUTES.SUB_CATEGORYS}`,
      allowedRoles: superAdmin_AdminStaff_and_StoreOwner,
      allowedShops: health_grocery_and_homeBusinessOnly
    },
    {
      title: 'common:nav-store-owner-text-reviews',
      icon: 'material-symbols:comment-outline',
      path: `/${shop}${ROUTES.REVIEWS}`,
      allowedRoles: superAdmin_AdminStaff_and_StoreOwner,
    },
    {
      title: 'common:nav-store-owner-text-withdraws',
      icon: 'iconoir:coins',
      path: `/${shop}${ROUTES.WITHDRAWS}`,
      allowedRoles: storeOwnerOnly,
    },
    {
      title: 'common:nav-store-owner-text-profile-settings',
      icon: 'ant-design:setting-outlined',
      path: `/${shop}${ROUTES.EDIT_SHOP}`,
      allowedRoles: superAdmin_and_storeOWner
    },
  ])
}

// const storeOwnerNavigation2 = (): VerticalNavItemsType => {
//   return [
//     {
//       title: 'Dashboards',
//       icon: 'tabler:layout-dashboard',
...
// export default storeOwnerNavigation2
