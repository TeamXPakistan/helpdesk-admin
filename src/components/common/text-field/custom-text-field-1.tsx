...
type InputTextFieldProps = TextFieldProps & { errorMsg?: string | null }
...
const CustomTextField1 = forwardRef((props: InputTextFieldProps, ref) => {
  // ** Props
  const { size = 'small', InputLabelProps, errorMsg, ...rest } = props
